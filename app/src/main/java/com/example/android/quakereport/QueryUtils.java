...
public final class QueryUtils {
    ...
    */
    ...
    private static URL createURL(String s) throws MalformedURLException {
        URL url=new URL(s);
        return url;
    }
    ...
    /**
     * Return a list of {@link location_info} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<location_info> extractEarthquakes(String earthquakeJSON) {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<location_info> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                earthquakes.add(new location_info(Double.valueOf(prop.getString("mag")),prop.getString("place"),prop.getLong("time"),prop.getString("url")));
            }
    ...
    public static ArrayList<location_info> fetchEarthquakeData(String url_string) throws IOException {
        URL url = createURL(url_string);
        String jsonResponse=makeHttpRequest(url);
        ArrayList<location_info> earthquake_data = extractEarthquakes(jsonResponse);
